...
document.querySelector('.adicao').onclick = function adicionar() {
    return console.log("O resultado da operação desejada é =", somar);
}
...
document.querySelector('.multiplicacao').onclick = function multiplicacao() {
    return alert("O resultado da operação desejada é =", multipl);
}
let multipl = function multiplicacao(numero1, numero2) {
    return (numero1 * numero2);
}
